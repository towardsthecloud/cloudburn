...
- Live scans require Resource Explorer access plus narrow hydrator permissions such as `ec2:DescribeVolumes`, `ec2:DescribeInstances`, `lambda:GetFunctionConfiguration`, `s3:GetLifecycleConfiguration`, and `s3:GetIntelligentTieringConfiguration`.
