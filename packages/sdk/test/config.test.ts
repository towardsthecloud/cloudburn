...
`,
  ...
  it('ignores auto-discovered config files when running in CI', async () => {
    const directory = await createTempDirectory();
...
`,
  ...
  it('treats an empty CI env var as non-CI for implicit config discovery', async () => {
    const directory = await createTempDirectory();
...
`,
  ...
  it('still loads an explicit config path while running in CI', async () => {
    const directory = await createTempDirectory();
    const configPath = join(directory, '.cloudburn.yml');
...
`,
  ...
  it('ignores duplicate auto-discovered config filenames while running in CI', async () => {
    const directory = await createTempDirectory();
