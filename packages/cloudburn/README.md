...
cloudburn discover --enabled-rules CLDBRN-AWS-SAGEMAKER-3
...
`CLDBRN-AWS-SAGEMAKER-3` is opt-in and requires AWS Cost Optimization Hub enrollment. CloudBurn checks enrollment but never changes it.
