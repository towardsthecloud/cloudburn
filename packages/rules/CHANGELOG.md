...
- [#290](https://github.com/towardsthecloud/cloudburn/pull/290) [`7940b9f`](https://github.com/towardsthecloud/cloudburn/commit/7940b9fc0b97678315476d5ad6a25c8310174514) Thanks [@axonstone](https://github.com/axonstone)! - Declare rule IDs immutable from this coordinated optimization-contract release onward: never renumber or reuse assigned IDs, including after removal. Gaps are valid and all existing IDs remain unchanged. Replace contiguous-number metadata assertions with uniqueness and positive, unpadded ID checks.
