...
| Generated output or releases                 | [Generated files](reference/generated-files.md), [release guide](guides/releasing.md)                                                                               | Package build configs, [Changesets config](../.changeset/config.json), [release workflow](../.github/workflows/release.yml), and [recovery tests](../test/release-recovery.test.mjs)                                                                        |
| GitHub Action behavior                       | [Action README](../packages/action/README.md), [package instructions](../packages/action/AGENTS.md), [generated files](reference/generated-files.md), and [testing](TESTING.md)                                                | [Action manifest](../packages/action/action.yml), [source](../packages/action/src/), [build config](../packages/action/tsup.config.ts), and [tests](../packages/action/test/)                                                                                                                 |
